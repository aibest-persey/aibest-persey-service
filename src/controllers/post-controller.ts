...
const AUTHOR_ATTRIBUTES = ["id", "username", "firstName", "lastName", "color"] as const;

const canModifyPost = async (post: Post, userId: string) => {
...
export const createPost = async (req: Request, res: Response): Promise<void> => {
  try {
    const { clubId, content } = req.body as CreatePostBody;
