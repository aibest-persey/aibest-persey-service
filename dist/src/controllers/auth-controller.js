    ...
    try {
        ...
        if (cached) {
            try {
                ...
                console.warn("Failed to parse cached user in me endpoint, falling back to DB", e);
            }
        }
        ...
        try {
            ...
            await redis.set(`user:${publicForCache.authString}`, JSON.stringify(publicForCache), { ex: 3600 });
            await redis.set(`userId:${publicForCache.id}`, JSON.stringify(publicForCache), { ex: 3600 });
        }
        catch (e) {
